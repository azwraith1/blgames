...
(function (Owen) {
    var UtilsString = (function () {
        ...
        UtilsString.isValidFloat = function (org) {
            var reg = /^(([1-9]{1}\d*)|(0{1}))(\.\d{0,2})?$/;
            return reg.test(org);
        };
        UtilsString.getType = function (type) {
            switch (type) {
                case 5:
                    return "退税";
                case 17:
        ...
        /**弹窗弹出效果 */
        UtilsString.popAni = function (target) {
            target.scaleX = 0;
            target.scaleY = 0;
            target.alpha = 0;
        ...
        //     },
        /**限制输入小数点后两位*/
        UtilsString.ForceTrim = function (org, len) {
        ...
        /**去掉空格*/
        UtilsString.ForceSpace = function (org) {
        ...
        UtilsString.playDB = function (dbName, parent, count, dispose, callBack, thisObj) {
            var _this = this;
            if (count === void 0) { count = 1; }
            if (dispose === void 0) { dispose = true; }
            if (callBack === void 0) { callBack = null; }
            if (thisObj === void 0) { thisObj = null; }
            var CacheName = dbName + 1;
            var db = GameCacheManager.instance.getCache(CacheName);
            if (!db) {
        ...
        UtilsString.createDBLoop = function (name, parent) {
    ...
    Owen.UtilsString = UtilsString;
    __reflect(UtilsString.prototype, "Owen.UtilsString");
    var Utils = (function () {
        function Utils() {
        }
        Utils.whenHttpError = function (data) {
         ...
         * @param addendNum 加数
        */
        Utils.additionFun = function (originalNum, addendNum) {
            var resultNum = 0;
            var s1 = 0;
            var s2 = 0;
            var m;
         ...
         * @param addendNum 减数
        */
        Utils.subtractionFun = function (originalNum, subtractedNum) {
            var resultNum = 0;
            var r1 = 0;
            var r2 = 0;
            var m = 0;
         ...
         * @param addendNum 倍数
        */
        Utils.multipleFun = function (originalNum, multipleNum) {
            var resultNum = 0;
            var m = 0;
            var s1 = originalNum.toString();
            var s2 = multipleNum.toString();
            try {
                m += s1.split(".")[1].length;
            }
            catch (e) { }
         ...
         * @param addendNum 除数
        */
        Utils.divisorFun = function (originalNum, divisorNum) {
            var resultNum = 0;
            var t1 = 0;
            var t2 = 0;
            var r1;
    ...
    Owen.Utils = Utils;
    __reflect(Utils.prototype, "Owen.Utils");
})(Owen || (Owen = {}));
