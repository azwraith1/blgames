 ...
 */
var BJLRecordPanel = (function (_super) {
    __extends(BJLRecordPanel, _super);
    function BJLRecordPanel(gameId) {
        var _this = _super.call(this) || this;
        _this.gameId = gameId;
        _this.skinName = "BJLRecordSkin" + CF.tis;
        return _this;
    }
    BJLRecordPanel.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        this.init();
    };
    BJLRecordPanel.prototype.init = function () {
    ...
    BJLRecordPanel.prototype.fuZhi = function (id) {
        ...
        if (this.recordData.length == 0) {
            ...
            for (var i = 0; i < this.recordData.length; i++) {
                var items = new BJLRecordRenderer(this.recordData[i], id);
                this.LiuShuiGroup.addChild(items);
            }
        }
    };
    BJLRecordPanel.prototype.onTouchTap = function (e) {
        e.stopPropagation();
        if (e.target == this.closeBtn || e.target == this.rects) {
            this.rects.visible = false;
            CF.sN(PanelNotify.CLOSE_BJL_RECORD);
        }
    };
    return BJLRecordPanel;
}(game.BaseComponent));
__reflect(BJLRecordPanel.prototype, "BJLRecordPanel");
