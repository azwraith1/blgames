...
var bjle;
(function (bjle) {
    var BjlLd3Panel = (function (_super) {
        __extends(BjlLd3Panel, _super);
        function BjlLd3Panel() {
        ...
        BjlLd3Panel.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
        };
        BjlLd3Panel.prototype.testNums = function (num) {
            //数据格式定义：1庄赢，2庄对，3闲对 ，4庄闲对；
            //				5闲赢，6庄对，7闲对，8庄闲对；
            //             9和局 ，10庄对，11闲对，12庄闲对。
            var dataArr = [9, 1, 12, 3, 4, 2, 6, 7, 2,
            ...
            var arry = bjle.BaseBjlLd.initQizi_dyxyjy(ResultArray, 3);
            ...
            if (ResultArray.length <= 24) {
                ...
                if (num_1.length > 6) {
                    index = num_1.length - 6;
                }
                var nums1 = nums.splice((-24 + index));
                this.initQizi(nums1);
            }
        };
        BjlLd3Panel.prototype.initQizi = function (arryList) {
        ...
        BjlLd3Panel.prototype.chushihua = function () {
            this.MaxLength = 6;
            for (var i = 0; i < 24; i++) {
    ...
    bjle.BjlLd3Panel = BjlLd3Panel;
    __reflect(BjlLd3Panel.prototype, "bjle.BjlLd3Panel");
})(bjle || (bjle = {}));
