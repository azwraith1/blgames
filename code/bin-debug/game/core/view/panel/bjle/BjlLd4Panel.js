...
var bjle;
(function (bjle) {
    var BjlLd4Panel = (function (_super) {
        __extends(BjlLd4Panel, _super);
        function BjlLd4Panel() {
        ...
        BjlLd4Panel.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
        };
        BjlLd4Panel.prototype.testNums = function (num) {
            var index = 1;
            ...
            var arry = bjle.BaseBjlLd.initQizi_dyxyjy(ResultArray, 4);
        ...
        BjlLd4Panel.prototype.initQizi = function (arryList) {
        ...
        BjlLd4Panel.prototype.chushihua = function () {
            this.MaxLength = 6;
            for (var i = 0; i < 24; i++) {
    ...
    bjle.BjlLd4Panel = BjlLd4Panel;
    __reflect(BjlLd4Panel.prototype, "bjle.BjlLd4Panel");
})(bjle || (bjle = {}));
