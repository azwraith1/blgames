 ...
 */
var BlackJRecordPanel = (function (_super) {
    __extends(BlackJRecordPanel, _super);
    function BlackJRecordPanel(gameId) {
        var _this = _super.call(this) || this;
        _this.gameId = gameId;
        if (gameId == 10024 || gameId == 10025) {
            _this.skinName = "BaiCaoRecordSkin";
        }
        else {
            _this.skinName = "BlackJRecordSkin" + CF.tis;
        }
        return _this;
    }
    BlackJRecordPanel.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        this.init();
    };
    BlackJRecordPanel.prototype.init = function () {
    ...
    BlackJRecordPanel.prototype.fuZhi = function (id) {
    ...
    BlackJRecordPanel.prototype.onTouchTap = function (e) {
        e.stopPropagation();
    ...
    return BlackJRecordPanel;
}(game.BaseComponent));
__reflect(BlackJRecordPanel.prototype, "BlackJRecordPanel");
