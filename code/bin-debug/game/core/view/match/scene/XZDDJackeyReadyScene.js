...
var XZDDJackeyReadyScene = (function (_super) {
    __extends(XZDDJackeyReadyScene, _super);
    function XZDDJackeyReadyScene() {
        ...
        _this.skinName = new XZDDJackeyReadySceneSkin();
        return _this;
    }
    Object.defineProperty(XZDDJackeyReadyScene, "instance", {
        get: function () {
    ...
    XZDDJackeyReadyScene.prototype.show = function () {
        game.UIUtils.changeResize(1);
        GameLayerManager.gameLayer().sceneLayer.addChild(this);
    };
    XZDDJackeyReadyScene.prototype.createChildren = function () {
    ...
    XZDDJackeyReadyScene.prototype.showRoomInfo = function () {
        // super.showRoomInfo();
        // this.changeDirections();
        // this.showPlayers();
    };
    XZDDJackeyReadyScene.prototype.onAdded = function () {
    ...
    XZDDJackeyReadyScene.prototype.onRemoved = function () {
    ...
    XZDDJackeyReadyScene.prototype.changeDirections = function () {
        var mineIndex = this.mineIndex;
    ...
    XZDDJackeyReadyScene.prototype.hide = function () {
        game.UIUtils.removeSelf(this);
        XZDDJackeyReadyScene._instance = null;
    };
    XZDDJackeyReadyScene.prototype.countdDown = function (e) {
        var resp = e.data;
        if (Global.gameProxy.roomInfo) {
            Global.gameProxy.roomInfo.countdown = resp;
        }
    };
    XZDDJackeyReadyScene.prototype.s_startNewRound = function (e) {
        var _this = this;
        var data = e.data;
        ...
        if (!Global.runBack) {
            WinNumberPanel.instance.show(Math.floor(this.proxy.roomInfo.backGold), function () {
                _this.checkStart();
            });
        }
        else {
    ...
    XZDDJackeyReadyScene.prototype.playerEnter = function (e) {
        var data = e.data;
        this.players[data.playerIndex] = data.player;
        Global.gameProxy.updatePlayer(data.playerIndex, data.player);
    };
    XZDDJackeyReadyScene.prototype.enterResult = function (e) {
        var data = e.data;
     ...
     * @param  {egret.Event} e
     */
    XZDDJackeyReadyScene.prototype.initHandCards = function (e) {
    ...
    XZDDJackeyReadyScene.prototype.checkStart = function () {
     ...
     * 开始游戏
     */
    XZDDJackeyReadyScene.prototype.startNewRound = function (e) {
     ...
     * @param  {egret.Event} e
     */
    XZDDJackeyReadyScene.prototype.playerjoin = function (e) {
        var resp = e.data;
        Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
    };
    XZDDJackeyReadyScene.prototype.reconnectSuc = function () {
        return __awaiter(this, void 0, void 0, function () {
            var matchSuc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.proxy.reconnectRoom()];
                    case 1:
                        matchSuc = _a.sent();
                        if (matchSuc) {
    ...
    return XZDDJackeyReadyScene;
}(BaseJackeyGameScene));
__reflect(XZDDJackeyReadyScene.prototype, "XZDDJackeyReadyScene");
