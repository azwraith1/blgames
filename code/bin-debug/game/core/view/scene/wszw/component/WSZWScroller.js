...
var wszw;
(function (wszw) {
    var WSZWScroller = (function (_super) {
        __extends(WSZWScroller, _super);
        function WSZWScroller() {
            ...
            _this.isRun = false;
            _this.overIndexes = [];
            _this.skinName = "WSZWScrollerSkin";
            return _this;
        }
        WSZWScroller.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            this.addEventListener(egret.Event.ENTER_FRAME, this.update, this);
        };
        WSZWScroller.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
            this.removeEventListener(egret.Event.ENTER_FRAME, this.update, this);
        };
        WSZWScroller.prototype.update = function (e) {
            if (!this.isRun) {
                return;
            }
        ...
        WSZWScroller.prototype.stopIconDb = function () {
            for (var i = 1; i <= 3; i++) {
                var item = this["item" + i].stopAni();
            }
        };
        WSZWScroller.prototype.run = function () {
            //还原
            this.isRun = true;
            this.overIndex = 1;
            this.overIndexes = [];
         ...
         * 快速旋转结果
         */
        WSZWScroller.prototype.runResultFast = function () {
         ...
         * @param  {} resultArr
         */
        WSZWScroller.prototype.runResult = function (resultArr) {
        ...
        WSZWScroller.prototype.changeResultByIndex = function (index) {
            switch (index) {
                case 1:
        ...
        WSZWScroller.prototype.changeSpeedByIndex = function (index) {
            switch (index) {
                case 1:
                    return 48 * 1;
                case 2:
        ...
        WSZWScroller.prototype.createChildren = function () {
         ...
         * @param  {} sceneIndex
         */
        WSZWScroller.prototype.initItemCounts = function (sceneIndex) {
            for (var i = 1; i <= 3; i++) {
                var item = this["item" + i];
         ...
         * @param  {} firstArr
         */
        WSZWScroller.prototype.initItemByFirst = function (index, firstArr) {
         ...
         * @param  {} excludeValue
         */
        WSZWScroller.prototype.getLine3Icon = function (excludeValue) {
            var arrWating = [];
            for (var i = 1; i <= 3; i++) {
                if (i != excludeValue) {
         ...
         */
        WSZWScroller.prototype.addBonusAni = function (allline, allscore) {
         ...
         */
        WSZWScroller.prototype.checkisInArray = function (num, array) {
        ...
        WSZWScroller.prototype.removeScroller = function () {
            for (var i = 1; i <= 3; i++) {
         ...
         * @param  {} index?
         */
        WSZWScroller.prototype.removeScatterAni = function (index) {
            game.UIUtils.removeSelf(this.scatterAni);
        };
        WSZWScroller.prototype.showFirst = function (sceneIndex) {
    ...
    wszw.WSZWScroller = WSZWScroller;
    __reflect(WSZWScroller.prototype, "wszw.WSZWScroller");
})(wszw || (wszw = {}));
