...
var majiang;
(function (majiang) {
    var HNMJMatchingScene = (function (_super) {
        __extends(HNMJMatchingScene, _super);
        function HNMJMatchingScene() {
             ...
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_HNMJ_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_HNMJ_HALL;
            /**
             * 进入游戏通知
             */
        ...
        HNMJMatchingScene.prototype.createChildren = function () {
        ...
        HNMJMatchingScene.prototype.onAdded = function () {
        ...
        HNMJMatchingScene.prototype.onRemoved = function () {
        ...
        HNMJMatchingScene.prototype.s_startNewRound = function (e) {
            var data = e.data;
            Global.gameProxy.roomInfo.dealer = data.dealer;
            this.isStart = true;
            this.checkStart();
        };
        HNMJMatchingScene.prototype.playerEnter = function (e) {
            var data = e.data;
            this.players[data.playerIndex] = data.player;
            Global.gameProxy.updatePlayer(data.playerIndex, data.player);
        };
        HNMJMatchingScene.prototype.enterResult = function (e) {
            ...
            Global.gameProxy.roomInfo.baoCards[0] = 47;
        };
        /**
         * 发牌
         * 收到发牌的消息跳转界面
         * @param  {egret.Event} e
         */
        HNMJMatchingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        HNMJMatchingScene.prototype.checkStart = function () {
         ...
         * @param  {egret.Event} e
         */
        HNMJMatchingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return HNMJMatchingScene;
    }(game.BaseMatchingScene));
    majiang.HNMJMatchingScene = HNMJMatchingScene;
    __reflect(HNMJMatchingScene.prototype, "majiang.HNMJMatchingScene");
})(majiang || (majiang = {}));
