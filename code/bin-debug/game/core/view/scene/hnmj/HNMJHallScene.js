 ...
 * @Description: 游戏选择场景。
 */
var HNMJHallScene = (function (_super) {
    __extends(HNMJHallScene, _super);
    function HNMJHallScene() {
         ...
         * 关闭当前界面的通知
         */
        _this.CLOSE_NOTIFY = SceneNotify.CLOSE_HNMJ_HALL;
        /**
         * 进入正确匹配的通知
         */
        _this.MATCHING_NOTIFY = SceneNotify.OPEN_HNMJ_MATCHING;
        /**
         * 帮助界面的通知
         */
         ...
         * 需要加载的资源组
         */
        _this.loadGroups = ['hnmj_game'];
        return _this;
        //this.skinName = `majiang.HNMJHallSceneSkin`;
    }
    HNMJHallScene.prototype.helpBtnTouch = function () {
        BaseMajiangHelpScene.getInstance("MajiangHelpSkin", "mj_help", "hnmj").show();
    };
    HNMJHallScene.prototype.recordBtnTouch = function () {
        CF.sN(PanelNotify.OPEN_BASE_RECORD, "hnmj");
    };
    HNMJHallScene.prototype.onAdded = function () {
        _super.prototype.onAdded.call(this);
        CF.aE(ENo.ENTER_GOLD_SCENE, this.enterScene, this);
    };
    HNMJHallScene.prototype.onRemoved = function () {
     ...
     * @param  {egret.Event} e?
     */
    HNMJHallScene.prototype.enterScene = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.lockEnter = true;
                data = e.data;
                RotationLoading.instance.load(["hnmj_game"], "", function () { return __awaiter(_this, void 0, void 0, function () {
                    var handler, resp;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
    ...
    HNMJHallScene.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        // this.headerImage.mask = this.headerMask;
    };
    return HNMJHallScene;
}(BaseMaJiangHallScene));
__reflect(HNMJHallScene.prototype, "HNMJHallScene");
