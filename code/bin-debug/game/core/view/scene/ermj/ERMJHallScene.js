...
var majiang;
(function (majiang) {
    var ERMJHallScene = (function (_super) {
        __extends(ERMJHallScene, _super);
        function ERMJHallScene() {
             ...
             * 关闭当前界面的通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_ERMJ_HALL;
            /**
             * 进入正确匹配的通知
             */
            _this.MATCHING_NOTIFY = SceneNotify.OPEN_ERMJ_MATCHING;
            /**
             * 帮助界面的通知
             */
            _this.HELP_NOTIFY = PanelNotify.OPEN_DZMJ_HELP;
            /**
             * 记录界面的通知
             */
            _this.RECORD_NOTIFY = PanelNotify.OPEN_DZMJRECORD;
            /**
             * 设置界面的通知
             */
         ...
         * @param  {egret.Event} e?
         */
        ERMJHallScene.prototype.enterScene = function (e) {
        ...
        ERMJHallScene.prototype.createChildren = function () {
        ...
        // 	}
        // }
        ERMJHallScene.prototype.getXIndex = function (index) {
            switch (index) {
                case 1:
                    return 170;
                case 2:
        ...
        return ERMJHallScene;
    }(BaseMaJiangHallScene));
    majiang.ERMJHallScene = ERMJHallScene;
    __reflect(ERMJHallScene.prototype, "majiang.ERMJHallScene");
})(majiang || (majiang = {}));
