...
var majiang;
(function (majiang) {
    var ERMJMatchingScene = (function (_super) {
        __extends(ERMJMatchingScene, _super);
        function ERMJMatchingScene() {
             ...
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_ERMJ_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_ERMJ_HALL;
            /**
             * 进入游戏通知
             */
        ...
        ERMJMatchingScene.prototype.createChildren = function () {
        ...
        ERMJMatchingScene.prototype.onAdded = function () {
        ...
        ERMJMatchingScene.prototype.onRemoved = function () {
        ...
        ERMJMatchingScene.prototype.s_playInitHua = function (e) {
            var data = e.data;
            for (var key in data) {
                var huaArr = data[key];
        ...
        ERMJMatchingScene.prototype.s_startNewRound = function (e) {
            var data = e.data;
            Global.gameProxy.roomInfo.dealer = data.dealer;
            this.isStart = true;
            this.checkStart();
        };
        ERMJMatchingScene.prototype.playerEnter = function (e) {
            var data = e.data;
            this.players[data.playerIndex] = data.player;
            Global.gameProxy.updatePlayer(data.playerIndex, data.player);
        };
        ERMJMatchingScene.prototype.enterResult = function (e) {
         ...
         * @param  {egret.Event} e
         */
        ERMJMatchingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        ERMJMatchingScene.prototype.checkStart = function () {
         ...
         * @param  {egret.Event} e
         */
        ERMJMatchingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return ERMJMatchingScene;
    }(game.BaseMatchingScene));
    majiang.ERMJMatchingScene = ERMJMatchingScene;
    __reflect(ERMJMatchingScene.prototype, "majiang.ERMJMatchingScene");
})(majiang || (majiang = {}));
