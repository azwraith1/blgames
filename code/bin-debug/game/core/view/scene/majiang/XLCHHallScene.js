...
var majiang;
(function (majiang) {
    var XLCHHallScene = (function (_super) {
        __extends(XLCHHallScene, _super);
        // public helpBtnTouch() {
        // 	BaseMajiangHelpScene.getInstance(`MajiangHelpSkin`, "mj_help", "hnmj").show();
        // }
        function XLCHHallScene() {
             ...
             * 关闭当前界面的通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_MJXLCH_HALL;
            /**
             * 进入正确匹配的通知
             */
            _this.MATCHING_NOTIFY = SceneNotify.OPEN_MJXLCH_MATCHING;
            /**
             * 帮助界面的通知
             */
        ...
        XLCHHallScene.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            CF.aE(ENo.ENTER_GOLD_SCENE, this.enterScene, this);
        };
        XLCHHallScene.prototype.onRemoved = function () {
         ...
         * 检查回到界面
         */
        XLCHHallScene.prototype.checkReconnectScene = function () {
            var _this = this;
        ...
        XLCHHallScene.prototype.helpBtnTouch = function () {
            BaseMajiangHelpScene.getInstance("MajiangHelpSkin", "mj_help", "xlch").show();
        };
        XLCHHallScene.prototype.recordBtnTouch = function () {
         ...
         * @param  {egret.Event} e?
         */
        XLCHHallScene.prototype.enterScene = function (event) {
        ...
        XLCHHallScene.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.headerImage.mask = this.headerMask;
        };
        return XLCHHallScene;
    }(BaseMaJiangHallScene));
    majiang.XLCHHallScene = XLCHHallScene;
    __reflect(XLCHHallScene.prototype, "majiang.XLCHHallScene");
})(majiang || (majiang = {}));
