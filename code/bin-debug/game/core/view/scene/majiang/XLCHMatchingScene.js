...
var majiang;
(function (majiang) {
    var XLCHMatchingScene = (function (_super) {
        __extends(XLCHMatchingScene, _super);
        function XLCHMatchingScene() {
            var _this = _super.call(this) || this;
            _this.pmdKey = "mjxlch";
            _this.GAME_ID = "mjxlch";
            _this.bgMusic = "playingingame_mp3";
            _this.players = {};
            /**
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_MJXLCH_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_MJXLCH_HALL;
            /**
             * 进入游戏通知
             */
        ...
        XLCHMatchingScene.prototype.createChildren = function () {
        ...
        XLCHMatchingScene.prototype.onAdded = function () {
        ...
        XLCHMatchingScene.prototype.onRemoved = function () {
         ...
         * @param  {egret.Event} e
         */
        XLCHMatchingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        XLCHMatchingScene.prototype.checkStart = function () {
         ...
         * 开始游戏
         */
        XLCHMatchingScene.prototype.startNewRound = function (e) {
         ...
         * @param  {egret.Event} e
         */
        XLCHMatchingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return XLCHMatchingScene;
    }(game.BaseMatchingScene));
    majiang.XLCHMatchingScene = XLCHMatchingScene;
    __reflect(XLCHMatchingScene.prototype, "majiang.XLCHMatchingScene");
})(majiang || (majiang = {}));
