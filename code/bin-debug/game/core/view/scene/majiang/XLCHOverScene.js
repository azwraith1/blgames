...
var majiang;
(function (majiang) {
    var XLCHOverScene = (function (_super) {
        __extends(XLCHOverScene, _super);
        function XLCHOverScene(data) {
            var _this = _super.call(this) || this;
            //new
            /**
             * 打开游戏界面通知
             */
            _this.GAME_SCENE_NOTIFY = SceneNotify.CLOSE_MJXLCH;
            /**
             * 关闭游戏界面通知
             */
             ...
             * 关闭当前界面通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_MJXLCH_OVER;
            /**
             * 对应匹配界面通知
             */
        ...
        XLCHOverScene.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            Global.runGame = false;
            CF.aE(ENo.EVENT_RESIZE, this.resetPosition, this);
        };
        XLCHOverScene.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
            CF.aE(ENo.EVENT_RESIZE, this.resetPosition, this);
        };
        XLCHOverScene.prototype.resetPosition = function (e) {
            var data = e.data;
        };
        XLCHOverScene.prototype.createChildren = function () {
        ...
        XLCHOverScene.prototype.show = function () {
         ...
         * 显示自己
         */
        XLCHOverScene.prototype.showMine = function (data, key) {
         ...
         *
         */
        XLCHOverScene.prototype.showOthers = function (data, key) {
        ...
        XLCHOverScene.prototype.getJia = function (gaiGold) {
            if (gaiGold > 0) {
                return "+";
            }
            else {
         ...
         * samrt
        */
        XLCHOverScene.prototype.setNameStyle = function () {
            var text;
            for (var i = 1; i < 5; ++i) {
         ...
         * 判断输赢图片
         */
        XLCHOverScene.prototype.winOrLoseImg = function (score) {
            if (score > 0) {
         ...
         * 动画
         */
        XLCHOverScene.prototype.moiveC = function () {
         ...
         * 判断输赢字体颜色。
         */
        XLCHOverScene.prototype.meWinOrLoseTextColor = function (fnt_color) {
            if (fnt_color > 0) {
         ...
         * 判断分数正负颜色 smart
         */
        XLCHOverScene.prototype.socreW2L = function (color) {
            if (color > 0) {
                return 0xf6b74b;
                //	return 0xfff729;
            }
        ...
        XLCHOverScene.prototype.onTouchTap = function (e) {
         ...
         * 返回对应游戏大厅
         */
        XLCHOverScene.prototype.backHall = function () {
         ...
         * 返回对应的匹配
         */
        XLCHOverScene.prototype.backMatching = function () {
            CF.sN(this.GAME_SCENE_NOTIFY);
            CF.sN(this.CLOSE_NOTIFY);
            CF.sN(this.MATCHING_SCENE_NOTIFY);
        };
        return XLCHOverScene;
    }(game.BaseGameScene));
    majiang.XLCHOverScene = XLCHOverScene;
    __reflect(XLCHOverScene.prototype, "majiang.XLCHOverScene");
})(majiang || (majiang = {}));
