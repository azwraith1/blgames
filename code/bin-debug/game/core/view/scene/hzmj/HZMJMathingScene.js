...
var majiang;
(function (majiang) {
    var HZMJMathingScene = (function (_super) {
        __extends(HZMJMathingScene, _super);
        function HZMJMathingScene() {
             ...
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_HZMJ_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_HZMJ_HALL;
            /**
             * 进入游戏通知
             */
        ...
        HZMJMathingScene.prototype.createChildren = function () {
        ...
        HZMJMathingScene.prototype.onAdded = function () {
        ...
        HZMJMathingScene.prototype.s_roomSetBaoCard = function (e) {
            // let data = e.data;
        ...
        HZMJMathingScene.prototype.onRemoved = function () {
        ...
        HZMJMathingScene.prototype.s_startNewRound = function (e) {
            var data = e.data;
            Global.gameProxy.roomInfo.dealer = data.dealer;
            this.isStart = true;
            this.checkStart();
        };
        HZMJMathingScene.prototype.playerEnter = function (e) {
            var data = e.data;
            this.players[data.playerIndex] = data.player;
            Global.gameProxy.updatePlayer(data.playerIndex, data.player);
        };
        HZMJMathingScene.prototype.enterResult = function (e) {
         ...
         * @param  {egret.Event} e
         */
        HZMJMathingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        HZMJMathingScene.prototype.checkStart = function () {
         ...
         * @param  {egret.Event} e
         */
        HZMJMathingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return HZMJMathingScene;
    }(game.BaseMatchingScene));
    majiang.HZMJMathingScene = HZMJMathingScene;
    __reflect(HZMJMathingScene.prototype, "majiang.HZMJMathingScene");
})(majiang || (majiang = {}));
