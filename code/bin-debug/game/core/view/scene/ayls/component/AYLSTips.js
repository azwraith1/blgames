...
var ayls;
(function (ayls) {
    var AYLSTips = (function (_super) {
        __extends(AYLSTips, _super);
        function AYLSTips() {
            var _this = _super.call(this) || this;
            _this.skinName = "AYLSTipsSkin";
            return _this;
        }
        AYLSTips.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.initData();
        };
        AYLSTips.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
        };
        AYLSTips.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
        };
        AYLSTips.prototype.onTouchTap = function (e) {
            switch (e.target) {
                case this.right1:
        ...
        AYLSTips.prototype.initData = function () {
            var data;
    ...
    ayls.AYLSTips = AYLSTips;
    __reflect(AYLSTips.prototype, "ayls.AYLSTips");
})(ayls || (ayls = {}));
