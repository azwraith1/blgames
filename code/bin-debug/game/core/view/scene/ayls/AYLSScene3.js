...
var ayls;
(function (ayls) {
    var AYLSScene3 = (function (_super) {
        __extends(AYLSScene3, _super);
        function AYLSScene3() {
            ...
            _this.skinName = "AYLSScene3Skin";
            return _this;
        }
        AYLSScene3.prototype.createChildren = function () {
         ...
         * @param  {egret.Event} e
         */
        AYLSScene3.prototype.scrollerEnd = function (e) {
            var _this = this;
            var data = e.data;
            var fastEnd3, fastEnd4, fastEnd5 = false;
            //场景id判断
         ...
         * 开始免费游戏
         */
        AYLSScene3.prototype.startFreeGame = function (e) {
            var _this = this;
            if (e.data) {
            ...
            this.scroller.showFreeFirst(3);
            egret.setTimeout(function () {
                _this.enterFreeAni.play("", 1);
                _this.enterFreeAni.horizontalCenter = 0;
                _this.enterFreeAni.bottom = 300;
                _this.resizeGroup.addChild(_this.enterFreeAni);
                _this.enterFreeAni.resetPosition();
                _this.enterFreeAni.callback = function () {
                    game.UIUtils.removeSelf(_this.enterFreeAni);
                    ...
                    if (!_this.isReconnect) {
                        egret.setTimeout(_this.playFreeGame, _this, 500);
                    }
                    else {
                        egret.setTimeout(_this.playFreeGame, _this, 500);
                    }
            ...
            egret.setTimeout(function () {
                ...
                _this.pawAni.play("", 1);
                _this.pawAni.horizontalCenter = 0;
                _this.pawAni.bottom = 340;
                _this.pawAni.callback = function () {
                    game.UIUtils.removeSelf(_this.pawAni);
                };
                _this.resizeGroup.addChild(_this.pawAni);
                _this.pawAni.resetPosition();
            }, this, 700);
         ...
         * 免费游戏旋转，次数判断
         */
        AYLSScene3.prototype.playFreeGame = function () {
            var _this = this;
            //防止重复发消息
            if (!this.isMessaged) {
                this.removeLastAni();
         ...
         * 发送免费游戏旋转消息
         */
        AYLSScene3.prototype.messageSend = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.winGold = 0;
                            this.lineTime = 1500;
                            data2 = { "spinType": 1, "bet": game.AYLSUtils.bet, "lineCount": 243, "activityId": 0 };
         ...
         * 移除之前动画
         */
        AYLSScene3.prototype.removeLastAni = function () {
            if (this.winGold > 0) {
         ...
         * 免费游戏中奖连线
         */
        AYLSScene3.prototype.addFreeBonusAni = function () {
            var _this = this;
            if (this.winGold > game.AYLSUtils.bet * 2 * 15) {
         ...
         * 免费游戏结算
         */
        AYLSScene3.prototype.showTotalWin = function () {
            var _this = this;
         ...
         * 免费游戏中scatter添加特效
         */
        AYLSScene3.prototype.addFreeTime = function () {
            var _this = this;
            egret.clearTimeout(this.freeGameTimeOut);
            ...
            egret.setTimeout(function () {
                ...
                _this.addFreeTimeAni.play("ayls_freespins_" + (_this.addedFreeTime), 1);
                _this.addFreeTimeAni.horizontalCenter = 0;
                _this.addFreeTimeAni.bottom = 300;
                _this.freegetFreeGroup.addChild(_this.addFreeTimeAni);
            ...
            egret.setTimeout(function () {
                _this.pawAni.play("", 1);
                _this.freegetFreeGroup.addChild(_this.pawAni);
                _this.pawAni.resetPosition();
                SoundManager.getInstance().playEffect("ayls_paw_mp3");
    ...
    ayls.AYLSScene3 = AYLSScene3;
    __reflect(AYLSScene3.prototype, "ayls.AYLSScene3");
})(ayls || (ayls = {}));
