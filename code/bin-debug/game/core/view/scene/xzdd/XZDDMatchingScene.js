...
var majiang;
(function (majiang) {
    var XZDDMatchingScene = (function (_super) {
        __extends(XZDDMatchingScene, _super);
        function XZDDMatchingScene() {
            var _this = _super.call(this) || this;
            _this.pmdKey = "mjxzdd";
            _this.GAME_ID = "mjxzdd";
            _this.bgMusic = "playingingame_mp3";
            _this.players = {};
            /**
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_MJXZDD_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_MJXZDD_HALL;
            /**
             * 进入游戏通知
             */
        ...
        XZDDMatchingScene.prototype.createChildren = function () {
        ...
        XZDDMatchingScene.prototype.showContent = function () {
        ...
        XZDDMatchingScene.prototype.onAdded = function () {
        ...
        XZDDMatchingScene.prototype.onRemoved = function () {
         ...
         * @param  {egret.Event} e
         */
        XZDDMatchingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        XZDDMatchingScene.prototype.checkStart = function () {
         ...
         * 开始游戏
         */
        XZDDMatchingScene.prototype.startNewRound = function (e) {
         ...
         * @param  {egret.Event} e
         */
        XZDDMatchingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return XZDDMatchingScene;
    }(game.BaseMatchingScene));
    majiang.XZDDMatchingScene = XZDDMatchingScene;
    __reflect(XZDDMatchingScene.prototype, "majiang.XZDDMatchingScene");
})(majiang || (majiang = {}));
