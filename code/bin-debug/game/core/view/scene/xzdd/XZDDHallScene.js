...
var majiang;
(function (majiang) {
    var XZDDHallScene = (function (_super) {
        __extends(XZDDHallScene, _super);
        // public helpBtnTouch() {
        // 	BaseMajiangHelpScene.getInstance(`MajiangHelpSkin`, "mj_help", "hnmj").show();
        // }
        function XZDDHallScene() {
             ...
             * 关闭当前界面的通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_MJXZDD_HALL;
            /**
             * 进入正确匹配的通知
             */
            _this.MATCHING_NOTIFY = SceneNotify.OPEN_MJXZDD_MATCHING;
            /**
             * 帮助界面的通知
             */
            ...
            return _this;
            // this.skinName = `XZDDHallSceneSkin`;
        }
        XZDDHallScene.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            CF.aE(ENo.ENTER_GOLD_SCENE, this.enterScene, this);
        };
        XZDDHallScene.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
            CF.rE(ENo.ENTER_GOLD_SCENE, this.enterScene, this);
        };
        XZDDHallScene.prototype.helpBtnTouch = function () {
            BaseMajiangHelpScene.getInstance("MajiangHelpSkin", "mj_help", "xzdd").show();
        };
        XZDDHallScene.prototype.recordBtnTouch = function () {
            CF.sN(PanelNotify.OPEN_BASE_RECORD, "mjxzdd");
        };
        /**
         * 检查回到界面
         */
        XZDDHallScene.prototype.checkReconnectScene = function () {
            var _this = this;
         ...
         * @param  {egret.Event} e?
         */
        XZDDHallScene.prototype.enterScene = function (event) {
        ...
        XZDDHallScene.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.headerImage.mask = this.headerMask;
        };
        return XZDDHallScene;
    }(BaseMaJiangHallScene));
    majiang.XZDDHallScene = XZDDHallScene;
    __reflect(XZDDHallScene.prototype, "majiang.XZDDHallScene");
})(majiang || (majiang = {}));
