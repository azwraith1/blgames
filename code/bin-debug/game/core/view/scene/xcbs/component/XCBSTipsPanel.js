...
var xcbs;
(function (xcbs) {
    var XCBSTipsPanel = (function (_super) {
        __extends(XCBSTipsPanel, _super);
        function XCBSTipsPanel() {
            var _this = _super.call(this) || this;
            _this.skinName = "XCBSTipsSkin";
            return _this;
        }
        XCBSTipsPanel.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.initData();
        };
        XCBSTipsPanel.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
        };
        XCBSTipsPanel.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
        };
        XCBSTipsPanel.prototype.onTouchTap = function (e) {
            switch (e.target) {
                case this.right1:
        ...
        XCBSTipsPanel.prototype.initData = function () {
            var data;
        ...
        return XCBSTipsPanel;
    }(game.BaseComponent));
    xcbs.XCBSTipsPanel = XCBSTipsPanel;
    __reflect(XCBSTipsPanel.prototype, "xcbs.XCBSTipsPanel");
})(xcbs || (xcbs = {}));
