...
var majiang;
(function (majiang) {
    var DZMJHallScene = (function (_super) {
        __extends(DZMJHallScene, _super);
        function DZMJHallScene() {
             ...
             * 关闭当前界面的通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_DZMJ_HALL;
            /**
             * 进入正确匹配的通知
             */
            _this.MATCHING_NOTIFY = SceneNotify.OPEN_DZMJ_MATCHING;
            /**
             * 帮助界面的通知
             */
        ...
        DZMJHallScene.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            CF.aE(ENo.ENTER_GOLD_SCENE, this.enterScene, this);
        };
        DZMJHallScene.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
            CF.rE(ENo.ENTER_GOLD_SCENE, this.enterScene, this);
        };
        DZMJHallScene.prototype.helpBtnTouch = function () {
            BaseMajiangHelpScene.getInstance("MajiangHelpSkin", "mj_help", "dzmj").show();
        };
        DZMJHallScene.prototype.recordBtnTouch = function () {
         ...
         * @param  {egret.Event} e?
         */
        DZMJHallScene.prototype.enterScene = function (e) {
        ...
        DZMJHallScene.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.headerImage.mask = this.headerMask;
            // this.createDb();
        };
        return DZMJHallScene;
    }(BaseMaJiangHallScene));
    majiang.DZMJHallScene = DZMJHallScene;
    __reflect(DZMJHallScene.prototype, "majiang.DZMJHallScene");
})(majiang || (majiang = {}));
