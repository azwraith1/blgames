...
var majiang;
(function (majiang) {
    var DZMJGameScene = (function (_super) {
        __extends(DZMJGameScene, _super);
        function DZMJGameScene() {
             ...
             * 关闭游戏界面通知
             */
            _this.HALL_SCENE_NOTIFY = SceneNotify.OPEN_DZMJ_HALL;
            /**
             * 关闭当前界面通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_DZMJ;
            /**
             * 对应匹配界面通知
             */
            _this.MATCHING_SCENE_NOTIFY = SceneNotify.OPEN_DZMJ_MATCHING;
            _this.skinName = new majiang.DZMJGameSceneSkin();
        ...
        */
        DZMJGameScene.prototype.fapaiRound4 = function (sortDir) {
            var _this = this;
            var indexNum = 0;
        ...
        DZMJGameScene.prototype.fapaiRoundOver = function () { };
        /**
         * 补花
         */
        DZMJGameScene.prototype.runBuhuaAni = function () {
            var _this = this;
         ...
         * 检查补花状态
         */
        DZMJGameScene.prototype.checkHuaStatus = function () {
            var _this = this;
            var roomInfo = Global.gameProxy.roomInfo;
            var players = roomInfo.players;
            for (var key in players) {
        ...
        DZMJGameScene.prototype.playerAddBuhua = function (outCard, newCard, playerIndex) {
            var _this = this;
         ...
         * todo不花
         */
        DZMJGameScene.prototype.playerBuhua = function (e) {
            var _this = this;
        ...
        DZMJGameScene.prototype.checkChupaiStatus = function () {
            var roomInfo = Global.gameProxy.roomInfo;
         ...
         * 回显花牌
         */
        DZMJGameScene.prototype.reloadHuas = function () {
            var roomInfo = Global.gameProxy.roomInfo;
        ...
        DZMJGameScene.prototype.reloadPlayerGangs = function () {
            _super.prototype.reloadPlayerGangs.call(this);
        };
        /**
         * 显示重新连接上来的UI
         */
        DZMJGameScene.prototype.showReconnectUI = function () {
            var roomInfo = Global.gameProxy.roomInfo;
        ...
        DZMJGameScene.prototype.renderContent = function () {
            var _this = this;
        ...
        DZMJGameScene.prototype.checkPlayerHasJiao = function () {
        ...
        DZMJGameScene.prototype.createChildren = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        DZMJGameScene.prototype.onTouchTap = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        //提牌，换三张，打牌的效果。
        DZMJGameScene.prototype.shoupaiTouchOn = function (e) {
        ...
        DZMJGameScene.prototype.chupaiReq = function (touchShoupai) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        DZMJGameScene.prototype.onAdded = function () {
        ...
        DZMJGameScene.prototype.onRemoved = function () {
        ...
        DZMJGameScene.prototype.tingInfoPush = function (e) {
            var data = e.data;
            var playerData = Global.gameProxy.getMineGameData();
            playerData.tingCards = this.currentTings = data;
        };
        DZMJGameScene.prototype.s_playerTingCards = function (e) {
            var data = e.data;
            var playerData = Global.gameProxy.getMineGameData();
         ...
         * @param  {} playerIndex
         */
        DZMJGameScene.prototype.add2HuGroup = function (card, playerIndex) {
            var direction = this.directions[playerIndex];
            this[direction + "HupaiGroup"].addBuhua(card);
        };
        DZMJGameScene.prototype.tuoguanStatusPush = function (e) {
            var resp = e.data;
            this.clearTingStatus();
         ...
         * 玩家报听推送
         */
        DZMJGameScene.prototype.playerBaoTingPush = function (e) {
            var resp = e.data;
         ...
         * 玩家吃牌推送
         */
        DZMJGameScene.prototype.playerChiCard = function (e) {
            this.clearCountDown();
            this.clearTingStatus();
            var resp = e.data;
            var playerIndex = resp.playerIndex;
        ...
        DZMJGameScene.prototype.clearTingStatus = function () {
            if (this.isTingStatus) {
         ...
         * @param  {egret.Event} e
         */
        DZMJGameScene.prototype.playCardPush = function (e) {
            this.clearCountDown();
            this.clearTingStatus();
            var resp = e.data;
            var playerIndex = resp.playerIndex;
        ...
        DZMJGameScene.prototype.clearTouchOn = function () {
            if (this.touchShoupai) {
                this.touchShoupai.change2NoSelect();
                this.touchShoupai = null;
                // this.hideBars();
         ...
         * @param  {} value
         */
        DZMJGameScene.prototype.showChupaiAni1 = function (playerIndex, value) {
            var _this = this;
            var direction = this.directions[playerIndex];
         ...
         * 检查task状态
         */
        DZMJGameScene.prototype.checkTask = function () {
            var roomInfo = Global.gameProxy.roomInfo;
         ...
         * @param  {egret.Event} e
         */
        DZMJGameScene.prototype.playerGangCard = function (e) {
            this.clearCountDown();
            this.clearTingStatus();
            var resp = e.data;
            var playerIndex = resp.playerIndex;
        ...
        DZMJGameScene.prototype.playerPengCardPush = function (e) {
        ...
        DZMJGameScene.prototype.publicCardChangedPush = function (e) {
            var resp = e.data;
            if (resp.cardNum > 91) {
                return;
            }
         ...
         * @param  {egret.Event} e
         */
        DZMJGameScene.prototype.newCardPush = function (e) {
            var resp = e.data;
            // this.taskBar.hideAllBtns();
            this.clearTingStatus();
            this.newCard(resp);
        ...
        DZMJGameScene.prototype.newCard = function (resp) {
         ...
         * @param  {egret.Event} e
         */
        DZMJGameScene.prototype.hupaiPush = function (e) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
         ...
         * 玩家报听
         */
        DZMJGameScene.prototype.playerBaoTing = function (tasks) {
         ...
         * @param  {} direction
         */
        DZMJGameScene.prototype.createRenshuFont = function (direction) {
        };
        /**
         * 呼叫转移漂分
         * @param  {} direction
         * @param  {} value
         */
        DZMJGameScene.prototype.createHJZYByDirection = function (direction, value) {
        };
        /**
         * 对局结束
         */
        DZMJGameScene.prototype.showDuijuAni = function (callback) {
        ...
        DZMJGameScene.prototype.showHuangZhuang = function (callback) {
            var name = "dzmj_hpts";
         ...
         * 游戏数据结算信息。
         */
        DZMJGameScene.prototype.settlementData = function (e) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                var resp, players;
                return __generator(this, function (_a) {
                    ...
                    this.showDuijuAni(function () {
                        ...
                        CF.sN(SceneNotify.OPEN_DZMJ_OVER, { players: players, status: resp.status, winPlayer: resp.winPlayer });
                    });
                    return [2 /*return*/];
                });
            });
        };
        DZMJGameScene.prototype.hideBars = function () {
            if (this.huTipsBar) {
                this.huTipsBar.hideBar();
            }
            if (this.ctBar) {
         ...
         * 听牌提示
         */
        DZMJGameScene.prototype.tipsBtnTouch = function () {
            if (!this.huTipsBar) {
        ...
        * 抢杠胡牌
        */
        DZMJGameScene.prototype.qiangGangHu = function (e) {
            this.g2p = 1;
            var resp = e.data;
            var direction = this.directions[resp.playerIndex];
         ...
         * 刷新胡牌提示
         */
        DZMJGameScene.prototype.tipsBarFlush = function () {
            if (!this.huTipsBar) {
                this.huTipsBar = new majiang.HuTipsBar();
                this.panelGroup.addChild(this.huTipsBar);
            }
        ...
        DZMJGameScene.prototype.showhupaiBar = function () {
         ...
         * 检查当前手牌能否胡牌
         */
        DZMJGameScene.prototype.updateTingByValue = function (value) {
            var playerData = Global.gameProxy.getMineGameData();
            if (playerData.isBaoTing) {
         ...
         * 展现胡牌
         */
        DZMJGameScene.prototype.showHuTips = function () {
        ...
        DZMJGameScene.prototype.getTingArr = function (tings, value) {
            for (var i = 0; i < tings.length; i++) {
                var ting = tings[i];
                if (ting.out == value) {
                    return ting.tings;
         ...
         * 检测胡牌提示
         */
        DZMJGameScene.prototype.checkHuTips = function () {
            var mineData = Global.gameProxy.getMineGameData();
            // if (Global.gameProxy.checkIsRoundMe()) {
            var tings = mineData.outCardTingCards;
            if (tings) {
        ...
        //-------游戏内提示
        DZMJGameScene.prototype.showGameTipGroup2 = function () {
        };
        DZMJGameScene.prototype.checkShowTips = function () {
            var roomInfo = Global.gameProxy.roomInfo;
        ...
        return DZMJGameScene;
    }(majiang.BaseMajiangScene));
    majiang.DZMJGameScene = DZMJGameScene;
    __reflect(DZMJGameScene.prototype, "majiang.DZMJGameScene");
})(majiang || (majiang = {}));
