...
var majiang;
(function (majiang) {
    var GDMJMatchingScene = (function (_super) {
        __extends(GDMJMatchingScene, _super);
        function GDMJMatchingScene() {
             ...
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_GDMJ_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_GDMJ_HALL;
            /**
             * 进入游戏通知
             */
        ...
        GDMJMatchingScene.prototype.createChildren = function () {
        ...
        GDMJMatchingScene.prototype.onAdded = function () {
        ...
        GDMJMatchingScene.prototype.onRemoved = function () {
        ...
        GDMJMatchingScene.prototype.s_roomSetBaoCard = function (e) {
            var data = e.data;
         ...
         * 买马
         */
        GDMJMatchingScene.prototype.s_roomBuyMa = function (e) {
            var data = e.data;
            var roomInfo = Global.gameProxy.roomInfo;
        ...
        GDMJMatchingScene.prototype.s_startNewRound = function (e) {
            var data = e.data;
            Global.gameProxy.roomInfo.dealer = data.dealer;
            this.isStart = true;
            this.checkStart();
        };
        GDMJMatchingScene.prototype.playerEnter = function (e) {
            var data = e.data;
            this.players[data.playerIndex] = data.player;
            Global.gameProxy.updatePlayer(data.playerIndex, data.player);
        };
        GDMJMatchingScene.prototype.enterResult = function (e) {
         ...
         * @param  {egret.Event} e
         */
        GDMJMatchingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        GDMJMatchingScene.prototype.checkStart = function () {
         ...
         * @param  {egret.Event} e
         */
        GDMJMatchingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return GDMJMatchingScene;
    }(game.BaseMatchingScene));
    majiang.GDMJMatchingScene = GDMJMatchingScene;
    __reflect(GDMJMatchingScene.prototype, "majiang.GDMJMatchingScene");
})(majiang || (majiang = {}));
