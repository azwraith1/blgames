...
var majiang;
(function (majiang) {
    var SCMJMatchingScene = (function (_super) {
        __extends(SCMJMatchingScene, _super);
        function SCMJMatchingScene() {
             ...
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_SCMJ_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_SCMJ_HALL;
            /**
             * 进入游戏通知
             */
        ...
        SCMJMatchingScene.prototype.createChildren = function () {
        ...
        SCMJMatchingScene.prototype.onAdded = function () {
        ...
        SCMJMatchingScene.prototype.onRemoved = function () {
         ...
         * @param  {egret.Event} e
         */
        SCMJMatchingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        SCMJMatchingScene.prototype.checkStart = function () {
         ...
         * 开始游戏
         */
        SCMJMatchingScene.prototype.startNewRound = function (e) {
         ...
         * @param  {egret.Event} e
         */
        SCMJMatchingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return SCMJMatchingScene;
    }(game.BaseMatchingScene));
    majiang.SCMJMatchingScene = SCMJMatchingScene;
    __reflect(SCMJMatchingScene.prototype, "majiang.SCMJMatchingScene");
})(majiang || (majiang = {}));
