 ...
 * @Last Modified time: 2019-10-10 17:59:58
 @Description: 麻将结算界面
 */
...
var majiang;
(function (majiang) {
    var SCMJOverScene = (function (_super) {
        __extends(SCMJOverScene, _super);
        function SCMJOverScene(data) {
            var _this = _super.call(this) || this;
            //new
            /**
             * 打开游戏界面通知
             */
            _this.GAME_SCENE_NOTIFY = SceneNotify.CLOSE_SCMJ;
            /**
             * 关闭游戏界面通知
             */
             ...
             * 关闭当前界面通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_SCMJ_OVER;
            /**
             * 对应匹配界面通知
             */
            ...
            _this.skinName = new MajiangJiesuanSceneSkin();
            return _this;
        }
        SCMJOverScene.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            Global.runGame = false;
            CF.aE(ENo.EVENT_RESIZE, this.resetPosition, this);
        };
        SCMJOverScene.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
            CF.aE(ENo.EVENT_RESIZE, this.resetPosition, this);
        };
        SCMJOverScene.prototype.resetPosition = function (e) {
            var data = e.data;
        };
        SCMJOverScene.prototype.createChildren = function () {
        ...
        SCMJOverScene.prototype.show = function () {
         ...
         * 显示自己
         */
        SCMJOverScene.prototype.showMine = function (data, key) {
         ...
         *
         */
        SCMJOverScene.prototype.showOthers = function (data, key) {
         ...
         * 判断输赢图片
         */
        SCMJOverScene.prototype.winOrLoseImg = function (score) {
            if (score > 0) {
         ...
         * 动画
         */
        SCMJOverScene.prototype.moiveC = function () {
         ...
         * 判断输赢字体颜色。
         */
        SCMJOverScene.prototype.meWinOrLoseTextColor = function (fnt_color) {
            if (fnt_color > 0) {
         ...
         * 判断分数正负颜色
         */
        SCMJOverScene.prototype.socreW2L = function (color) {
            if (color > 0) {
                return 0xfff729;
            }
            else {
        ...
        SCMJOverScene.prototype.onTouchTap = function (e) {
         ...
         * 返回对应游戏大厅
         */
        SCMJOverScene.prototype.backHall = function () {
         ...
         * 返回对应的匹配
         */
        SCMJOverScene.prototype.backMatching = function () {
            CF.sN(this.GAME_SCENE_NOTIFY);
            CF.sN(this.CLOSE_NOTIFY);
            CF.sN(this.MATCHING_SCENE_NOTIFY);
        };
        return SCMJOverScene;
    }(game.BaseGameScene));
    majiang.SCMJOverScene = SCMJOverScene;
    __reflect(SCMJOverScene.prototype, "majiang.SCMJOverScene");
})(majiang || (majiang = {}));
