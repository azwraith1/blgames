...
var csd;
(function (csd) {
    var CSDIcon = (function (_super) {
        __extends(CSDIcon, _super);
        function CSDIcon() {
            var _this = _super.call(this) || this;
            _this.iconKey = "csd";
            _this.skinName = new CSDIconSkin();
            return _this;
        }
        CSDIcon.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
        };
        CSDIcon.prototype.changeRamdom = function (min, max) {
            if (min === void 0) { min = 1; }
            if (max === void 0) { max = 3; }
         ...
         * @param  {} source
         */
        CSDIcon.prototype.changeSource = function (source) {
        ...
        * @param  {} value
        */
        CSDIcon.prototype.changeSouceByValue = function (value) {
            this.value = value;
         ...
         * @param  {} value
         */
        CSDIcon.prototype.changeSourceByNameValue = function (iconKey, value) {
            this.value = value;
      ...
      * 展示中奖图标效果，特效
      */
        CSDIcon.prototype.showSdDbComponet = function () {
            var _this = this;
       ...
       * @param  {} name
       */
        CSDIcon.prototype.createDbCom = function (name) {
        ...
        * 调整icon动画位置
        */
        CSDIcon.prototype.changePosition = function () {
            this.dbComp.x = 120;
            this.dbComp.y = 190;
        };
        CSDIcon.prototype.showRect = function () {
        };
        CSDIcon.prototype.hideRect = function () {
        };
        /**
        * 动画结束隐藏
        */
        CSDIcon.prototype.hideDbComponent = function () {
            if (this.dbComp) {
                this.dbComp.stop();
         ...
         * 动画完成移除
         */
        CSDIcon.prototype.stopDbComponet = function () {
    ...
    csd.CSDIcon = CSDIcon;
    __reflect(CSDIcon.prototype, "csd.CSDIcon");
})(csd || (csd = {}));
