...
var csd;
(function (csd) {
    var CSDScroller = (function (_super) {
        __extends(CSDScroller, _super);
        function CSDScroller() {
            ...
            _this.isRun = false;
            _this.overIndexes = [];
            _this.skinName = "SCDScrollerSkin";
            return _this;
        }
        CSDScroller.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            this.addEventListener(egret.Event.ENTER_FRAME, this.update, this);
        };
        CSDScroller.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
            this.removeEventListener(egret.Event.ENTER_FRAME, this.update, this);
        };
        CSDScroller.prototype.update = function (e) {
            if (!this.isRun) {
                return;
            }
        ...
        CSDScroller.prototype.stopIconDb = function () {
            for (var i = 1; i <= 3; i++) {
                var item = this["item" + i].stopAni();
            }
        };
        CSDScroller.prototype.run = function () {
            //还原
            this.isRun = true;
            this.overIndex = 1;
            this.overIndexes = [];
         ...
         * 快速旋转结果
         */
        CSDScroller.prototype.runResultFast = function () {
         ...
         * @param  {} resultArr
         */
        CSDScroller.prototype.runResult = function (resultArr) {
        ...
        CSDScroller.prototype.changeResultByIndex = function (index) {
            switch (index) {
                case 1:
        ...
        CSDScroller.prototype.changeSpeedByIndex = function (index) {
            switch (index) {
                case 1:
                    return 48 * 1;
                case 2:
        ...
        CSDScroller.prototype.createChildren = function () {
         ...
         * @param  {} sceneIndex
         */
        CSDScroller.prototype.initItemCounts = function (sceneIndex) {
            for (var i = 1; i <= 3; i++) {
                var item = this["item" + i];
         ...
         * @param  {} firstArr
         */
        CSDScroller.prototype.initItemByFirst = function (index, firstArr) {
         ...
         * @param  {} excludeValue
         */
        CSDScroller.prototype.getLine3Icon = function (excludeValue) {
            var arrWating = [];
            for (var i = 1; i <= 3; i++) {
                if (i != excludeValue) {
         ...
         */
        CSDScroller.prototype.addBonusAni = function (allline, allscore) {
         ...
         */
        CSDScroller.prototype.checkisInArray = function (num, array) {
        ...
        CSDScroller.prototype.removeScroller = function () {
            for (var i = 1; i <= 3; i++) {
         ...
         * @param  {} index?
         */
        CSDScroller.prototype.removeScatterAni = function (index) {
            game.UIUtils.removeSelf(this.scatterAni);
        };
        CSDScroller.prototype.showFirst = function (sceneIndex) {
    ...
    csd.CSDScroller = CSDScroller;
    __reflect(CSDScroller.prototype, "csd.CSDScroller");
})(csd || (csd = {}));
