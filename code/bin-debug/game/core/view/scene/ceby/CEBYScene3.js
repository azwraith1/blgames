...
var ceby;
(function (ceby) {
    var CEBYScene3 = (function (_super) {
        __extends(CEBYScene3, _super);
        /**
         * 免费游戏中免费游戏动画
         */
        ...
        function CEBYScene3() {
            ...
            _this.skinName = "CEBYScene3Skin";
            return _this;
        }
        CEBYScene3.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            // this.addFreeTimeAni = DBComponent.create("ayls_addfreetimeani", "ayls_freespins_n");
            this.enterFreeAni = new DBComponent("ceby_bg02");
            this.scroller.showFreeFirst(3);
            this.enterFreeAni.play("", 0);
            this.enterFreeAni.touchEnabled = false;
            this.freegameAniGroup.addChild(this.enterFreeAni);
            this.enterFreeAni.resetPosition();
            this.changeAni = DBComponent.create("ceby_icon2_act1", "ceby_icon2_act");
            this.changeAni.horizontalCenter = 1000;
            this.changeAni.bottom = 0;
            this.freegetFreeGroup.addChild(this.changeAni);
            this.changeAni.resetPosition();
            this.changeAni.touchEnabled = false;
            egret.setInterval(this.cloudMove, this, 40000);
        };
        CEBYScene3.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
            CF.aE(ENo.LHJ_ITEM_OVER, this.scrollerEnd, this);
            CF.aE(ENo.CEBY_START_FREE_GAME, this.startFreeGame, this);
        };
        CEBYScene3.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
            CF.rE(ENo.LHJ_ITEM_OVER, this.scrollerEnd, this);
            CF.rE(ENo.CEBY_START_FREE_GAME, this.startFreeGame, this);
        };
        CEBYScene3.prototype.cloudMove = function () {
            this.leftcloud1.left = -380;
            this.leftcloud1.right = 1280;
            this.rightcloud1.left = 1280;
            this.rightcloud1.right = -350;
            this.rightcloud2.left = 1280;
            this.rightcloud2.right = -420;
            egret.Tween.get(this.leftcloud1).to({ left: 1280, right: -380 }, 35000);
            egret.Tween.get(this.rightcloud1).to({ left: -350, right: 1280 }, 40000);
            egret.Tween.get(this.rightcloud2).to({ left: -420, right: 1280 }, 30000);
        };
        /**
         * 转轴转动结束
         * @param  {egret.Event} e
         */
        CEBYScene3.prototype.scrollerEnd = function (e) {
            var _this = this;
            var data = e.data;
            //场景id判断
         ...
         * 开始免费游戏
         */
        CEBYScene3.prototype.startFreeGame = function (e) {
            var _this = this;
            if (e.data) {
            ...
            egret.setTimeout(function () {
                ...
                if (!_this.isReconnect) {
                    // egret.Tween.get(this.waterAni).to({ bottom: -300 }, 1000).call(() => {
                    _this.playFreeGame();
                    // })
                }
                else {
            ...
            SoundManager.getInstance().playMusic("ceby_freespinbackground_mus_mp3");
            /**
             * 是否为免费游戏重连
             */
        };
         ...
         * 免费游戏旋转，次数判断
         */
        CEBYScene3.prototype.playFreeGame = function () {
            var _this = this;
            //防止重复发消息
            if (!this.isMessaged) {
                this.removeLastAni();
                ...
                this.freeGameTimeOut = egret.setTimeout(function () {
                    SoundManager.getInstance().playEffect("ceby_reel_mp3", true);
                    _this.scroller.run();
                    _this.messageSend();
         ...
         * 发送免费游戏旋转消息
         */
        CEBYScene3.prototype.messageSend = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.winGold = 0;
                            this.lineTime = 2500;
                            data2 = { "spinType": 1, "bet": game.CEBYUtils.bet, "lineCount": 243, "activityId": 0 };
                        ...
                        case 1:
                            ...
                            this.lineTime = this.lineTime + this.bonusAtr.length * 300;
                            if (this.scatter == 1)
                                this.lineTime += 1500;
                            ...
                            game.CEBYUtils.ToTalMoney = resp2.own_gold;
         ...
         * 移除之前动画
         */
        CEBYScene3.prototype.removeLastAni = function () {
            if (this.winGold > 0) {
         ...
         * 免费游戏中奖连线
         */
        CEBYScene3.prototype.addFreeBonusAni = function () {
            var _this = this;
            if (this.winGold > game.CEBYUtils.bet * 2 * 15) {
        ...
        CEBYScene3.prototype.showTotalWin = function () {
            ...
            egret.setTimeout(function () {
                ...
                CF.dP(ENo.CEBY_QUIT_FREE_GAME);
                _this.totalGroup.visible = false;
                _this.leftcloud1.left = -380;
                _this.leftcloud1.right = 1280;
                _this.rightcloud1.left = 1280;
                _this.rightcloud1.right = -250;
                _this.rightcloud2.left = 1280;
                _this.rightcloud2.right = -420;
            }, this, 8000);
        };
        /**
         * 免费游戏中scatter添加特效
         */
        CEBYScene3.prototype.addFreeTime = function () {
            var _this = this;
            egret.clearTimeout(this.freeGameTimeOut);
            this.freeGameTimeOut = egret.setTimeout(this.playFreeGame, this, this.bonusAtr.length * 500 + 6000);
            // egret.setTimeout(() => {
            this.freegetFreeGroup.visible = true;
            this.freegetFreeGroup.alpha = 1;
            this.freegetFreeTimes.source = "ceby_freegetfree_" + this.addedFreeTime + "_png";
            egret.setTimeout(function () {
                _this.freeLeftGroup.visible = true;
                egret.Tween.get(_this.freeLeftGroup).to({ scaleX: 1, scaleY: 1 }, 1000, egret.Ease.bounceOut);
            }, this, 500);
            egret.setTimeout(function () {
                _this.freeLeftGroup.visible = false;
                _this.freeLeftGroup.scaleX = _this.freeLeftGroup.scaleY = 0;
                _this.changeAni.horizontalCenter = 1000;
                _this.freegetFreeGroup.visible = false;
            }, this, 4500);
        };
        return CEBYScene3;
    }(game.BaseSlotScene3));
    ceby.CEBYScene3 = CEBYScene3;
    __reflect(CEBYScene3.prototype, "ceby.CEBYScene3");
})(ceby || (ceby = {}));
