...
var ceby;
(function (ceby) {
    var CEBYBaseIcon = (function (_super) {
        __extends(CEBYBaseIcon, _super);
        function CEBYBaseIcon() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.iconKey = "ceby";
            _this.dbName = "ceby_icon2_guang";
         ...
         * 添加sdxl scatter特效
         */
        CEBYBaseIcon.prototype.addScatter = function (str) {
            var _this = this;
    ...
    ceby.CEBYBaseIcon = CEBYBaseIcon;
    __reflect(CEBYBaseIcon.prototype, "ceby.CEBYBaseIcon");
})(ceby || (ceby = {}));
