...
var bskg;
(function (bskg) {
    var BSKGBigwinPanel = (function (_super) {
        __extends(BSKGBigwinPanel, _super);
        // public bgAni2: DBComponent;
        function BSKGBigwinPanel() {
            var _this = _super.call(this) || this;
            _this.score = 0;
            _this.testscore = 0;
            _this.isTouched = false;
            _this.isPlayingMusic = false; //是否在播放背景音乐
            _this.skinName = "BSKGBigwinPanelSkin";
            return _this;
        }
        BSKGBigwinPanel.prototype.createChildren = function () {
         ...
         */
        BSKGBigwinPanel.prototype.showScore = function (num, callback) {
            var _this = this;
            ...
            this.showResultTimeOut = egret.setTimeout(function () {
                ...
                _this.winImag.source = RES.getRes("bskg_bigwin_text_png");
            ...
            this.timer1.addEventListener(egret.TimerEvent.TIMER, function () {
                if (_this.testscore < (game.BSKGUtils.bet * game.BSKGUtils.mul * 50) * 30 && _this.testscore < num) {
                ...
                else if (_this.testscore < 50 * (game.BSKGUtils.bet * game.BSKGUtils.mul * 50) && _this.testscore >= 30 * (game.BSKGUtils.bet * game.BSKGUtils.mul * 50) && _this.testscore < num) {
                    ...
                    if (!is_mega) {
                        ...
                        _this.effectGroup.addChild(_this.titleChangeAni);
                        _this.titleChangeAni.resetPosition();
                        _this.winImag.source = RES.getRes("bskg_megawin_text_png");
                        SoundManager.getInstance().playEffect("bskg_bigwinchange_mp3");
                ...
                else if (_this.testscore >= 50 * (game.BSKGUtils.bet * game.BSKGUtils.mul * 50) && _this.testscore < num) {
                    ...
                    if (!is_super) {
                        ...
                        _this.titleChangeAni.resetPosition();
                        SoundManager.getInstance().playEffect("bskg_bigwinchange_mp3");
                        _this.winImag.source = RES.getRes("bskg_superwin_text_png");
                        egret.Tween.get(_this.winImag).to({ scaleX: 0.2, scaleY: 0.2 }, 20).to({ scaleX: 1, scaleY: 1 }, 200, egret.Ease.sineOut).to({ scaleX: 0.8, scaleY: 0.8 }, 80).to({ scaleX: 1.1, scaleY: 1.1 }, 60).to({ scaleX: 0.9, scaleY: 0.9 }, 60).to({ scaleX: 1, scaleY: 1 }, 50).call(function () {
        ...
        BSKGBigwinPanel.prototype.addGoldDown = function () {
            var _this = this;
            this.timer2 = egret.setInterval(function () {
                if (_this.bigwinPanel.numChildren < 30) {
                    var gold_right1 = game.GoldDownPanel.createBskgGold2("bskg_bigwin2");
                    _this.bigwinPanel.addChild(gold_right1);
                    var gold_right2 = game.GoldDownPanel.createBskgGold2("bskg_bigwin3");
                    _this.bigwinPanel.addChild(gold_right2);
                    var gold_left1 = game.GoldDownPanel.createBskgGold2("bskg_bigwin4");
                    _this.bigwinPanel.addChild(gold_left1);
                    var gold_left2 = game.GoldDownPanel.createBskgGold2("bskg_bigwin5");
        ...
        * @param  {Function} callback?
        */
        BSKGBigwinPanel.prototype.stopShowBigWin = function (callback) {
            var _this = this;
            //禁止重复点击
            if (this.isTouched)
                return;
       ...
       * @param  {Function} callback?
       */
        BSKGBigwinPanel.prototype.removeThisPanel = function (callback) {
            var _this = this;
        ...
        return BSKGBigwinPanel;
    }(game.BaseComponent));
    bskg.BSKGBigwinPanel = BSKGBigwinPanel;
    __reflect(BSKGBigwinPanel.prototype, "bskg.BSKGBigwinPanel");
})(bskg || (bskg = {}));
