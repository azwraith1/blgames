...
var bscs;
(function (bscs) {
    var BSCSTips = (function (_super) {
        __extends(BSCSTips, _super);
        function BSCSTips() {
            var _this = _super.call(this) || this;
            _this.skinName = "BSCSTipsSkin";
            return _this;
        }
        BSCSTips.prototype.createChildren = function () {
            _super.prototype.createChildren.call(this);
            this.initData();
        };
        BSCSTips.prototype.onAdded = function () {
            _super.prototype.onAdded.call(this);
        };
        BSCSTips.prototype.onRemoved = function () {
            _super.prototype.onRemoved.call(this);
        };
        BSCSTips.prototype.onTouchTap = function (e) {
            switch (e.target) {
                case this.right1:
        ...
        BSCSTips.prototype.initData = function () {
            var data;
    ...
    bscs.BSCSTips = BSCSTips;
    __reflect(BSCSTips.prototype, "bscs.BSCSTips");
})(bscs || (bscs = {}));
