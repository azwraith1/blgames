...
var majiang;
(function (majiang) {
    var GYZJHallScene = (function (_super) {
        __extends(GYZJHallScene, _super);
        // public helpBtnTouch() {
        // 	BaseMajiangHelpScene.getInstance(`MajiangHelpSkin`, "mj_help", "hnmj").show();
        // }
        function GYZJHallScene() {
        ...
        //  */
             ...
             * 关闭当前界面的通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_GYZJMJ_HALL;
            /**
             * 进入正确匹配的通知
             */
            _this.MATCHING_NOTIFY = SceneNotify.OPEN_GYZJ_MATCHING;
            /**
             * 帮助界面的通知
             */
             ...
             * 记录界面的通知
             */
            _this.RECORD_NOTIFY = PanelNotify.OPEN_GYZJRECORD;
            /**
             * 设置界面的通知
             */
         ...
         * @param  {egret.Event} e?
         */
        GYZJHallScene.prototype.enterScene = function (event) {
        ...
        GYZJHallScene.prototype.createChildren = function () {
     ...
     * 玩家信息
     */
        GYZJHallScene.prototype.renderPlayerInfo = function () {
            _super.prototype.renderPlayerInfo.call(this);
            // this.headerImage.scaleX = 1.7;
            // this.headerImage.scaleY = 1.7;
        };
        return GYZJHallScene;
    }(BaseMaJiangHallScene));
    majiang.GYZJHallScene = GYZJHallScene;
    __reflect(GYZJHallScene.prototype, "majiang.GYZJHallScene");
})(majiang || (majiang = {}));
