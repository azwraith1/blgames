...
var majiang;
(function (majiang) {
    var GYZJMatchingScene = (function (_super) {
        __extends(GYZJMatchingScene, _super);
        function GYZJMatchingScene() {
            var _this = _super.call(this) || this;
            _this.pmdKey = "gyzjmj";
            _this.GAME_ID = "gyzjmj";
            _this.bgMusic = "playingingame_mp3";
            _this.players = {};
            /**
             * 关闭匹配通知
             */
            _this.CLOSE_NOTIFY = SceneNotify.CLOSE_GYZJ_MATCHING;
            /**
             * 打开游戏大厅
             */
            _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_GYZJMJ_HALL;
            /**
             * 进入游戏通知
             */
        ...
        GYZJMatchingScene.prototype.createChildren = function () {
        ...
        GYZJMatchingScene.prototype.onAdded = function () {
        ...
        GYZJMatchingScene.prototype.onRemoved = function () {
         ...
         * @param  {egret.Event} e
         */
        GYZJMatchingScene.prototype.initHandCards = function (e) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        GYZJMatchingScene.prototype.checkStart = function () {
         ...
         * 开始游戏
         */
        GYZJMatchingScene.prototype.startNewRound = function (e) {
         ...
         * @param  {egret.Event} e
         */
        GYZJMatchingScene.prototype.playerjoin = function (e) {
            var resp = e.data;
            Global.gameProxy.joinPlayer(resp.playerIndex, resp.player);
        };
        return GYZJMatchingScene;
    }(game.BaseMatchingScene));
    majiang.GYZJMatchingScene = GYZJMatchingScene;
    __reflect(GYZJMatchingScene.prototype, "majiang.GYZJMatchingScene");
})(majiang || (majiang = {}));
