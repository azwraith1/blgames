...
var ERMJHallBar = (function (_super) {
    __extends(ERMJHallBar, _super);
    function ERMJHallBar(data, index, gameType) {
        var _this = _super.call(this) || this;
        _this.lock = false;
        _this.config = data;
        _this.index = index;
        _this.gameType = gameType;
        _this.skinName = "ERMJHallBarSkin";
        return _this;
    }
    ERMJHallBar.prototype.onAdded = function () {
        _super.prototype.onAdded.call(this);
        game.UIUtils.setAnchorPot(this);
        this.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchEnded, this);
    };
    ERMJHallBar.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        this.showBarByConfig(this.config);
    };
    ERMJHallBar.prototype.onTouchEnded = function () {
        var _this = this;
        ...
        RotationLoading.instance.load(["ermj_game"], "", function () {
    ...
    ERMJHallBar.prototype.showBarByConfig = function (num) {
    ...
    ERMJHallBar.prototype.getDBName = function () {
        switch (this.index) {
            case 1:
...
__reflect(ERMJHallBar.prototype, "ERMJHallBar");
