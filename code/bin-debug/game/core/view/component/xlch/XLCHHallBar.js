...
var XLCHHallBar = (function (_super) {
    __extends(XLCHHallBar, _super);
    function XLCHHallBar(data, index, gameType) {
        var _this = _super.call(this) || this;
        _this.lock = false;
        _this.config = data;
        _this.index = index;
        _this.gameType = gameType;
        _this.skinName = "XLCHHallBarSkin";
        return _this;
    }
    XLCHHallBar.prototype.onAdded = function () {
        _super.prototype.onAdded.call(this);
        game.UIUtils.setAnchorPot(this);
        this.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchEnded, this);
    };
    XLCHHallBar.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        this.showBarByConfig(this.config);
    };
    XLCHHallBar.prototype.onTouchEnded = function () {
        var _this = this;
    ...
    XLCHHallBar.prototype.showBarByConfig = function (num) {
        this.dizhuLabel.text = num.bet_base;
        this.zhunruLabel.text = num.gold_min;
        var dbComponent = GameCacheManager.instance.getCache("xlch_xc_" + this.index);
        if (!dbComponent) {
    ...
    XLCHHallBar.prototype.getDBName = function () {
        switch (this.index) {
            case 1:
                return "xlch_cjc";
            case 2:
...
__reflect(XLCHHallBar.prototype, "XLCHHallBar");
