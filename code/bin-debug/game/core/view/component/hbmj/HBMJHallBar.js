...
var HBMJHallBar = (function (_super) {
    __extends(HBMJHallBar, _super);
    function HBMJHallBar(data, index, gameType) {
        var _this = _super.call(this) || this;
        _this.lock = false;
        _this.config = data;
        _this.index = index;
        _this.gameType = gameType;
        _this.skinName = "HBMJHallBarSkin";
        return _this;
    }
    HBMJHallBar.prototype.onAdded = function () {
        _super.prototype.onAdded.call(this);
        game.UIUtils.setAnchorPot(this);
        this.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchEnded, this);
    };
    HBMJHallBar.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        this.showBarByConfig(this.config);
    };
    HBMJHallBar.prototype.onTouchEnded = function () {
        var _this = this;
    ...
    HBMJHallBar.prototype.showBarByConfig = function (num) {
    ...
    HBMJHallBar.prototype.getDBName = function () {
        switch (this.index) {
            case 1:
...
__reflect(HBMJHallBar.prototype, "HBMJHallBar");
