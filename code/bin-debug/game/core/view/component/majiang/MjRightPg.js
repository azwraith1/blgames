/*
 * @Author: he bing
 * @Date: 2018-07-12 14:13:57
 * @Last Modified by: MC Lee
 * @Last Modified time: 2019-07-19 10:45:55
 * @Description: 右家牌碰杠渲染赋值
 */
...
var majiang;
(function (majiang) {
    var MjRightPg = (function (_super) {
        __extends(MjRightPg, _super);
        function MjRightPg(type, color, lgth, pbg) {
            var _this = _super.call(this, type, color, lgth, pbg) || this;
            if (lgth == 1) {
                _this.skinName = new MjRightPgSkin4();
                _this.times = 1;
            }
            else if (lgth == 2) {
                _this.skinName = new MjRightPgSkin3();
                _this.times = 2;
            }
            else if (lgth == 3) {
                _this.skinName = new MjRightPgSkin2();
                _this.times = 3;
            }
            else if (lgth == 4) {
                _this.skinName = new MjRightPgSkin();
                _this.times = 4;
            }
            return _this;
        }
        MjRightPg.prototype.createChildren = function () {
        ...
        MjRightPg.prototype.resetPGAniPos = function (db) {
            db.x = 40;
            db.y = 55;
        };
        /**
         * 显示第几堆牌
         */
        MjRightPg.prototype.showType = function (type, time) {
            ...
            switch (this.type) {
                ...
                case 2:
                case 4:
                    this.image1.source = "right_angang_" + time + "_png";
                    this.image2.source = "right_angang_" + (time + 1) + "_png";
                    this.image3.source = "right_angang_" + (time + 2) + "_png";
                    this.showColor_a();
                    break;
            }
        };
        //给碰牌麻将牌的牌面赋值。
        MjRightPg.prototype.showColor = function () {
        ...
        //给明杠牌麻将牌的牌面赋值。
        MjRightPg.prototype.showColor_m = function () {
            this.value1.source = "color_value_" + this.color + "_png";
            this.value3.source = "color_value_" + this.color + "_png";
            this.value4.source = "color_value_" + this.color + "_png";
        };
        MjRightPg.prototype.showColor_pbg = function () {
        ...
        //给暗杠牌麻将牌的牌面赋值。
        MjRightPg.prototype.showColor_a = function () {
            this.value4.source = "color_value_" + this.color + "_png";
        };
        /**
 * 杠变碰显动画；
 */
        MjRightPg.prototype.dianpaoAni = function () {
    ...
    majiang.MjRightPg = MjRightPg;
    __reflect(MjRightPg.prototype, "majiang.MjRightPg");
})(majiang || (majiang = {}));
