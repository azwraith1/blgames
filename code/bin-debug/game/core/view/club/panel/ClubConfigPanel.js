...
var ClubConfigPanel = (function (_super) {
    __extends(ClubConfigPanel, _super);
    function ClubConfigPanel() {
        var _this = _super.call(this) || this;
        _this.skinName = "ClubConfigPanelSkin" + CF.tis; //"ClubConfigPanelSkin";
        return _this;
    }
    Object.defineProperty(ClubConfigPanel, "instance", {
        get: function () {
    ...
    ClubConfigPanel.prototype.onTouchTap = function (e) {
    ...
    ClubConfigPanel.prototype.breakClub = function () {
        return __awaiter(this, void 0, void 0, function () {
            var hander, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        hander = ServerPostPath.hall_clubHandler_c_disbandClub;
    ...
    ClubConfigPanel.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
    };
    ClubConfigPanel.prototype.hide = function () {
        game.UIUtils.removeSelf(this);
        ClubConfigPanel._instance = null;
    };
    ClubConfigPanel.prototype.show = function () {
        if (this.clubSet.requestLock)
            return;
        // this.clubSet.flushUI();
    ...
    ClubConfigPanel.prototype.showOpenGameBtn = function () {
        this.clubOpenGameBtn.visible = false;
        if (ClubManager.instance.currentClub.role == 1) {
            this.clubOpenGameBtn.visible = true;
        }
    };
    return ClubConfigPanel;
}(BaseInstanceScence));
__reflect(ClubConfigPanel.prototype, "ClubConfigPanel");
