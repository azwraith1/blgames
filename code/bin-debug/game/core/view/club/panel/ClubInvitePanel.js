...
var ClubInvitePanel = (function (_super) {
    ...
    function ClubInvitePanel() {
        var _this = _super.call(this) || this;
        _this.skinName = "ClubInviteMemberPanelSkin" + CF.tis;
        return _this;
    }
    Object.defineProperty(ClubInvitePanel, "instance", {
        get: function () {
    ...
    ClubInvitePanel.prototype.hide = function () {
        game.UIUtils.removeSelf(ClubInvitePanel._instance);
        ClubInvitePanel._instance = null;
    };
    ClubInvitePanel.prototype.show = function (memberList) {
        this.right = 0;
        this.bottom = 110;
        this.memberList.dataProvider = new eui.ArrayCollection(memberList);
        return this;
    };
    ClubInvitePanel.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
        this.memberList.itemRenderer = ClubInviteItem;
        this.initMember();
    };
    ClubInvitePanel.prototype.initMember = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp, atr, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, game.PomeloManager.instance.request(ServerPostPath.hall_clubHandler_c_getInvitePlayerList, {})];
                    case 1:
                        resp = _a.sent();
...
__reflect(ClubInvitePanel.prototype, "ClubInvitePanel");
