...
// TypeScript file
var ClubMailItem = (function (_super) {
    __extends(ClubMailItem, _super);
    function ClubMailItem() {
        var _this = _super.call(this) || this;
        _this.skinName = "ClubMailItemSkin";
        return _this;
    }
    ClubMailItem.prototype.createChildren = function () {
        _super.prototype.createChildren.call(this);
    };
    ClubMailItem.prototype.dataChanged = function () {
        this.updateShow(this.data);
        this.clubstate.x = this.miaoshu.x + this.miaoshu.width + 15;
    };
    ClubMailItem.prototype.updateShow = function (data) {
        if (data) {
    ...
    ClubMailItem.prototype.fmtDate = function (obj) {
    ...
    ClubMailItem.prototype.onTouchTap = function (e) {
        switch (e.target) {
            case this.deleteBtn:
                this.deleteMail();
                break;
    ...
    ClubMailItem.prototype.deleteMail = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, game.PomeloManager.instance.request(ServerPostPath.hall_userHandler_c_delMail, { id: this.thisId })];
                    case 1:
                        resp = _a.sent();
                        if (resp) {
...
__reflect(ClubMailItem.prototype, "ClubMailItem");
