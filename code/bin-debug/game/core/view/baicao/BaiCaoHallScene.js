...
var BaiCaoHallScene = (function (_super) {
    __extends(BaiCaoHallScene, _super);
    function BaiCaoHallScene() {
         ...
         * 关闭当前界面的通知
         */
        _this.CLOSE_NOTIFY = SceneNotify.CLOSE_BAICAO_HALL;
        /**
         * 进入正确匹配的通知
         */
        _this.MATCHING_NOTIFY = SceneNotify.OPEN_BAICAO_MATCHING;
        /**
         * 帮助界面的通知
         */
     ...
     * @param  {egret.Event} e?
     */
    BaiCaoHallScene.prototype.enterScene = function (event) {
    ...
    /**
         * 渲染hallScene
         */
    BaiCaoHallScene.prototype.showHallBars = function () {
        this.centerGroup.alpha = 0;
        var nums = Global.gameProxy.gameNums["baicao"];
        var index = 1;
        var item;
    ...
    BaiCaoHallScene.prototype.resetPosition = function (item, index) {
        switch (index) {
            case 1:
                break;
            case 2:
     ...
     * 帮助按钮
     */
    BaiCaoHallScene.prototype.helpBtnTouch = function () {
        BaiCaoHelpPanel.instance.show("baicao");
    };
    return BaiCaoHallScene;
}(game.BaseHallScene));
__reflect(BaiCaoHallScene.prototype, "BaiCaoHallScene");
