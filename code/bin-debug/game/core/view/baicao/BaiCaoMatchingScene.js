...
var BaiCaoMatchingScene = (function (_super) {
    __extends(BaiCaoMatchingScene, _super);
    function BaiCaoMatchingScene() {
        var _this = _super.call(this) || this;
        _this.pmdKey = "baicao";
        _this.GAME_ID = "baicao";
        _this.players = {};
         ...
         * 关闭匹配通知
         */
        _this.CLOSE_NOTIFY = SceneNotify.CLOSE_BAICAO_MATCHING;
        /**
         * 打开游戏大厅
         */
        _this.GAME_HALL_NOTIFY = SceneNotify.OPEN_BAICAO_HALL;
        /**
         * 进入游戏通知
         */
    ...
    BaiCaoMatchingScene.prototype.createChildren = function () {
    ...
    BaiCaoMatchingScene.prototype.resetPMDPosition = function () {
        var publicMsg = PMDComponent.instance;
        publicMsg.anchorOffsetY = 24;
        publicMsg.horizontalCenter = 10;
        publicMsg.top = 50;
    };
    BaiCaoMatchingScene.prototype.onAdded = function () {
    ...
    BaiCaoMatchingScene.prototype.onRemoved = function () {
    ...
    BaiCaoMatchingScene.prototype.enterResult = function (e) {
    ...
    BaiCaoMatchingScene.prototype.playerEnter = function (e) {
        var data = e.data;
        this.players[data.playerIndex] = data.player;
        Global.roomProxy.updatePlayer(data.playerIndex, data.player);
    };
    BaiCaoMatchingScene.prototype.startNewRound = function (e) {
        this.allowBack = false;
     ...
     * 超时匹配或者断线重连
     */
    BaiCaoMatchingScene.prototype.reconnectSuc = function () {
        return __awaiter(this, void 0, void 0, function () {
            var matchSuc;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return BaiCaoMatchingScene;
}(game.BaseMatchingScene));
__reflect(BaiCaoMatchingScene.prototype, "BaiCaoMatchingScene");
