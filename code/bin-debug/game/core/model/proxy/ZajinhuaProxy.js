...
var game;
(function (game) {
    var ZajinhuaProxy = (function (_super) {
        __extends(ZajinhuaProxy, _super);
        function ZajinhuaProxy() {
        ...
        ZajinhuaProxy.prototype.init = function () {
            Global.zajinhuaProxy = this;
            this.listenOnCall();
        };
        ZajinhuaProxy.prototype.listenOnCall = function () {
        };
        ZajinhuaProxy.prototype.req2updateRoom = function () {
                            ...
                            return [2 /*return*/, new Promise(function (resolve, reject) {
                                    if (resp && resp.roomInfo) {
                                        if (!_this.roomInfo) {
                                            ...
                                            _.extendOwn(_this.roomInfo, resp.roomInfo);
                                        }
         ...
         * @param  {} roomInfo
         */
        ZajinhuaProxy.prototype.setRoomInfo = function (enterSceneResp) {
        ...
        ZajinhuaProxy.prototype.updatePlayer = function (index, player) {
            if (!this.roomInfo) {
                return;
            }
        ...
        /**
             ...
             * @param  {} playerIndex
             */
        ZajinhuaProxy.prototype.getPlayerByIndex = function (playerIndex) {
            if (!this.roomInfo) {
                return;
            }
         ...
         * 得到游戏玩家
         */
        ZajinhuaProxy.prototype.getPlayers = function () {
            if (!this.roomInfo) {
                return [];
            }
            return this.roomInfo.players;
        };
        ZajinhuaProxy.prototype.getPlayersLength = function () {
            return _.keys(this.roomInfo.players).length;
        };
        /**
         * 获取玩家本人的index
         */
        ZajinhuaProxy.prototype.getMineIndex = function () {
            if (!this.playerInfo) {
                return null;
            }
         ...
         * @param  {} index
         */
        ZajinhuaProxy.prototype.checkIndexIsMe = function (index) {
            return game.Utils.valueEqual(index, this.playerInfo.playerIndex);
        };
        ZajinhuaProxy.prototype.getMineInfo = function () {
            return this.roomInfo.players[this.playerInfo.playerIndex];
        };
        ZajinhuaProxy.prototype.getPlayerInfoByIndex = function (index) {
            return this.roomInfo.players[index];
        };
        ZajinhuaProxy.prototype.clearRoomInfo = function () {
            this.roomInfo = null;
     ...
     */
        ZajinhuaProxy.getDirectionByMine = function (mineIndex) {
            var direction = {};
            switch (mineIndex) {
                case 1:
                    direction["1"] = "1";
        ...
        ZajinhuaProxy.NAME = "ZajinhuaProxy";
        return ZajinhuaProxy;
    }(ResourceProxyBase));
    game.ZajinhuaProxy = ZajinhuaProxy;
    __reflect(ZajinhuaProxy.prototype, "game.ZajinhuaProxy");
})(game || (game = {}));
