...
module majiang {
	export class MjRightPg extends BasePGItem {
		public constructor(type, color, lgth, pbg?) {
			super(type, color, lgth, pbg);
			if (lgth == 1) {
				this.skinName = new MjRightPgSkin4();
				this.times = 1;
			} else if (lgth == 2) {
				this.skinName = new MjRightPgSkin3();
				this.times = 2;
			} else if (lgth == 3) {
				this.skinName = new MjRightPgSkin2();
				this.times = 3;
			} else if (lgth == 4) {
				this.skinName = new MjRightPgSkin();
				this.times = 4;
			}
		}
