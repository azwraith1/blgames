module rbwar {
	export class RBWarGameScene extends game.BaseGameScene {
		...
		//新增赢的龙骨 smart
		private winDBGroup: eui.Group;
		private winDirection: RBWWinAni;
		...
		/**展示红或者黑赢*/
		private showWinDirection(isHong: boolean = true) {
		...
		private winDB: DBComponent;
		public playwinDB() {
			let db = new DBComponent("hhdz_win");
			db.callback = () => {
