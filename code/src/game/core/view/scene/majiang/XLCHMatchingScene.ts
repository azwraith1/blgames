module majiang {
    export class XLCHMatchingScene extends game.BaseMatchingScene {
		 ...
		 * 关闭匹配通知
		 */
        public CLOSE_NOTIFY: string = SceneNotify.CLOSE_MJXLCH_MATCHING;

		/**
		 * 打开游戏大厅
		 */
        public GAME_HALL_NOTIFY: string = SceneNotify.OPEN_MJXLCH_HALL;
