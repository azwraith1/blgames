// TypeScript file
module zcjl {
    export class ZCJLScroller extends game.BaseUI {
        public scroller: eui.Scroller;
        public itemGroup: eui.Group;
        public item1: ZCJLScrollerItem;
        public item2: ZCJLScrollerItem;
        public item3: ZCJLScrollerItem;
        ...
        public constructor() {
            super();
            this.skinName = "ZCJLScrollerSkin";
        }
        ...
        public update(e: egret.Event) {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as ZCJLScrollerItem //.itemDown(this.speed);
                item.itemDown();
            }
        }
        public stopIconDb() {
        ...
        public run() {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as ZCJLScrollerItem;
                item.startRun();
            }
        }
        ...
        public runResultFast() {
            if (this.resultArrList) {
                ...
                for (let i = 0; i < resultArr.length; i++) {
                    ...
                    let item = this[`item${i + 1}`] as ZCJLScrollerItem;
        ...
        public initItemByFirst(index, firstArr) {
            let item = this[`item${index}`] as ZCJLScrollerItem;
