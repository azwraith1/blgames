module majiang {
    export class HBMJMatchingScene extends game.BaseMatchingScene {
        public pmdKey: string = "mjxlch";
        public bgMusic: string = "playingingame_mp3";
        public GAME_ID: string = "hbmj";
        //玩法
		 ...
		 * 关闭匹配通知
		 */
        public CLOSE_NOTIFY: string = SceneNotify.CLOSE_HBMJ_MATCHING;

		/**
		 * 打开游戏大厅
		 */
        public GAME_HALL_NOTIFY: string = SceneNotify.OPEN_HBMJ_HALL;
