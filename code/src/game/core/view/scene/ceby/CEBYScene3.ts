// TypeScript file
module ceby {
    export class CEBYScene3 extends game.BaseSlotScene3 {
        public resizeGroup: eui.Group;
        public gameGroup: eui.Group;
        public scroller: bscs.BSCSScroller;
        ...
        */
        ...
        public leftcloud1: eui.Image;
        public rightcloud1: eui.Image;
        public rightcloud2: eui.Image;

        public cloudMove() {
            this.leftcloud1.left = -380; this.leftcloud1.right = 1280;
            this.rightcloud1.left = 1280; this.rightcloud1.right = -350;
            this.rightcloud2.left = 1280; this.rightcloud2.right = -420;
        ...
        public async messageSend() {
            ...
            this.winGold = 0;
            this.lineTime = 2500;
            let data2 = { "spinType": 1, "bet": game.CEBYUtils.bet, "lineCount": 243, "activityId": 0 };
        ...
        public showTotalWin() {
            ...
            egret.setTimeout(() => {
                ...
                this.leftcloud1.left = -380; this.leftcloud1.right = 1280;
                this.rightcloud1.left = 1280; this.rightcloud1.right = -250;
                this.rightcloud2.left = 1280; this.rightcloud2.right = -420;
            }, this, 8000);
        }

        public freegetFreeTimes: eui.Image;
        ...
        public addFreeTime() {
            ...
            egret.setTimeout(() => {
                ...
                egret.Tween.get(this.freeLeftGroup).to({ scaleX: 1, scaleY: 1 }, 1000, egret.Ease.bounceOut);
            }, this, 500);
            egret.setTimeout(() => {
                this.freeLeftGroup.visible = false;
                this.freeLeftGroup.scaleX = this.freeLeftGroup.scaleY = 0;
                this.changeAni.horizontalCenter = 1000;
