// TypeScript file
module wszw {
    export class WSZWScroller extends game.BaseUI {
        public scroller: eui.Scroller;
        public itemGroup: eui.Group;
        public item1: WSZWScrollerItem;
        public item2: WSZWScrollerItem;
        public item3: WSZWScrollerItem;
        ...
        public constructor() {
            super();
            this.skinName = "WSZWScrollerSkin";
        }
        ...
        public update(e: egret.Event) {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as WSZWScrollerItem //.itemDown(this.speed);
                item.itemDown();
            }
        }
        public stopIconDb() {
        ...
        public run() {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as WSZWScrollerItem;
                item.startRun();
            }
        }
        ...
        public runResultFast() {
            if (this.resultArrList) {
                ...
                for (let i = 0; i < resultArr.length; i++) {
                    ...
                    let item = this[`item${i + 1}`] as WSZWScrollerItem;
        ...
        public initItemByFirst(index, firstArr) {
            let item = this[`item${index}`] as WSZWScrollerItem;
