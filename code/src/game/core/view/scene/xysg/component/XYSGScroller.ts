// TypeScript file
module xysg {
    export class XYSGScroller extends game.BaseUI {
        public scroller: eui.Scroller;
        public itemGroup: eui.Group;
        public item1: XYSGScrollerItem;
        public item2: XYSGScrollerItem;
        public item3: XYSGScrollerItem;
        ...
        public constructor() {
            super();
            this.skinName = "XYSGScrollerSkin";
        }
        ...
        public update(e: egret.Event) {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as XYSGScrollerItem //.itemDown(this.speed);
                item.itemDown(i);
            }
        }
        public stopIconDb() {
        ...
        public run() {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as XYSGScrollerItem;
                item.startRun();
            }
        }
        ...
        public runResultFast() {
            if (this.resultArrList) {
                ...
                for (let i = 0; i < resultArr.length; i++) {
                    ...
                    let item = this[`item${i + 1}`] as XYSGScrollerItem;
        ...
        public initItemByFirst(index, firstArr) {
            let item = this[`item${index}`] as XYSGScrollerItem;
