...
module majiang {
	export class SCMJOverScene extends game.BaseGameScene {
		 ...
		 * 打开游戏界面通知
		 */
		public GAME_SCENE_NOTIFY: string = SceneNotify.CLOSE_SCMJ;
		 ...
		 * 关闭当前界面通知
		 */
		public CLOSE_NOTIFY: string = SceneNotify.CLOSE_SCMJ_OVER;
