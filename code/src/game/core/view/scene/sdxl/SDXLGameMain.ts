 ...
 */
module sdxl {
	export class SDXLGameMain extends game.BaseSlotMainScene {
		public scene1: sdxl.SDXLGameScene1;
		public scene3: sdxl.SDXLGameScene3;
		private toFreeAni: DBComponent;
		public pmdKey = "slot";
		public gameId = "sdxl";
		public closeTipsNotify = PanelNotify.CLOSE_SDXL_TIPS;
		public enterFreeNotify = ENo.SDXL_ENTER_FREE_GAME_SCENE;
		public quitFreeNotify = ENo.SDXL_QUIT_FREE_GAME;
		public startFreeSceneNotify = ENo.SDXL_START_FREE_GAME_SCENE;
		public closeSceneNotify = SceneNotify.CLOSE_SDXL;
		public closeAutNotify = PanelNotify.CLOSE_SDXL_AUTO_PANEL;
