...
module majiang {
	export class XZDDOverScene extends game.BaseGameScene {
	...
	/**
		 ...
		 * 打开游戏界面通知
		 */
		public GAME_SCENE_NOTIFY: string = SceneNotify.CLOSE_MJXZDD;
		 ...
		 * 关闭当前界面通知
		 */
		public CLOSE_NOTIFY: string = SceneNotify.CLOSE_MJXZDD_OVER;
