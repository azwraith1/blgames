class BlackJackMatchingScene extends game.BaseMatchingScene {
	public pmdKey: string = "blackjack";
	public GAME_ID: string = "blackjack";
	private players = {};
	 ...
	 * 关闭匹配通知
	 */
	public CLOSE_NOTIFY: string = SceneNotify.CLOSE_BLACKJ_MATCHING;

	/**
	 * 打开游戏大厅
	 */
	public GAME_HALL_NOTIFY: string = SceneNotify.OPEN_BLACKJ_HALL;
	...
	public constructor() {
		super();
		this.skinName = new BlackJackMatchingSceneSkin();
	}
