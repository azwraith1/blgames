module majiang {
    export class HNMJMatchingScene extends game.BaseMatchingScene {
        public pmdKey: string = "mjxlch";
        public bgMusic: string = "playingingame_mp3";
        public GAME_ID: string = "hnmj";
        //玩法
		 ...
		 * 关闭匹配通知
		 */
        public CLOSE_NOTIFY: string = SceneNotify.CLOSE_HNMJ_MATCHING;

		/**
		 * 打开游戏大厅
		 */
        public GAME_HALL_NOTIFY: string = SceneNotify.OPEN_HNMJ_HALL;
