// TypeScript file
module csd {
    export class CSDScroller extends game.BaseUI {
        public scroller: eui.Scroller;
        public itemGroup: eui.Group;
        public item1: CSDScrollerItem;
        public item2: CSDScrollerItem;
        public item3: CSDScrollerItem;
        ...
        public update(e: egret.Event) {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as CSDScrollerItem //.itemDown(this.speed);
                item.itemDown();
            }
        }
        public stopIconDb() {
        ...
        public run() {
            ...
            for (let i = 1; i <= 3; i++) {
                let item = this[`item${i}`] as CSDScrollerItem;
                item.startRun();
            }
        }
        ...
        public runResultFast() {
            if (this.resultArrList) {
                ...
                for (let i = 0; i < resultArr.length; i++) {
                    ...
                    let item = this[`item${i + 1}`] as CSDScrollerItem;
        ...
        public initItemByFirst(index, firstArr) {
            let item = this[`item${index}`] as CSDScrollerItem;
