 ...
 */
module bskg {
	export class BSKGScroller extends game.BaseUI {
		private scroller: eui.Scroller;
		private itemGroup: eui.Group;
		public item1: BSKGScrollerItem;
		public item2: BSKGScrollerItem;
		public item3: BSKGScrollerItem;
		public item4: BSKGScrollerItem;
		public item5: BSKGScrollerItem;
		...
		public constructor() {
			super();
			this.skinName = "BSKGScrollerSkin";
		}
		...
		public update(e: egret.Event) {
			...
			for (let i = 1; i <= 5; i++) {
				let item = this[`item${i}`] as BSKGScrollerItem //.itemDown(this.speed);
				item.itemDown();
			}
		}
		public stopIconDb() {
		...
		public run() {
			...
			for (let i = 1; i <= 5; i++) {
				let item = this[`item${i}`] as BSKGScrollerItem;
				item.startRun();
			}
		}
		public freeRun() {
		...
		public runResultFast() {
			if (this.resultArrList) {
				...
				for (let i = 0; i < resultArr.length; i++) {
					...
					let item = this[`item${i + 1}`] as BSKGScrollerItem;
		...
		public initItemByFirst(index, firstArr) {
			let item = this[`item${index}`] as BSKGScrollerItem;
