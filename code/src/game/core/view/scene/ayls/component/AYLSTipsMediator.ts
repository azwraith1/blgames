 ...
 */
module ayls{
    export class AYLSTipsMediator extends BaseMediator{
        public static NAME: string = "AYLSTipsMediator";
		public type: string = "panel";
		public constructor() {
			super(AYLSTipsMediator.NAME);
		}

		public viewComponent: AYLSTips;
		...
		public showViewComponent() {
			...
			this.viewComponent = new AYLSTips();
