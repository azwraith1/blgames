class BaiCaoHallScene extends game.BaseHallScene {
	public hallId: string = "baicao";
	public pmdKey: string = "baicao";
	 ...
	 * 关闭当前界面的通知
	 */
	public CLOSE_NOTIFY: string = SceneNotify.CLOSE_BAICAO_HALL;

	/**
	 * 进入正确匹配的通知
	 */
	public MATCHING_NOTIFY: string = SceneNotify.OPEN_BAICAO_MATCHING;
	 ...
	 * 需要加载的资源组
	 */
	public loadGroups: string[] = ['baicao_game'];
	...
	public constructor() {
		super();
		this.skinName = new BaiCaoHallSceneSkin();
	}
	...
	public showHallBars() {
		...
		for (let i in nums) {
			...
			let bar = this['bar' + index] as BaiCaoHallBar;
