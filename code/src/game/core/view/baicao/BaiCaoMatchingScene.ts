class BaiCaoMatchingScene extends game.BaseMatchingScene {
	public pmdKey: string = "baicao";
	public GAME_ID: string = "baicao";
	private players = {};
	 ...
	 * 关闭匹配通知
	 */
	public CLOSE_NOTIFY: string = SceneNotify.CLOSE_BAICAO_MATCHING;

	/**
	 * 打开游戏大厅
	 */
	public GAME_HALL_NOTIFY: string = SceneNotify.OPEN_BAICAO_HALL;
